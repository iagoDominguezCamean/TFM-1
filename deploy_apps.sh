...
if [ $cluster == "kubenet" ]; then
    ...
    kubectl --kubeconfig="/home/iagodc/.kube/config_kubenet" apply -f k8s/app1-pod.yaml
    kubectl --kubeconfig="/home/iagodc/.kube/config_kubenet" apply -f k8s/app1-svc.yaml
